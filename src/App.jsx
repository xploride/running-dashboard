...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <input ref={attachInputRef} hidden type="file" accept=".gpx,application/gpx+xml" onChange={handleAttach}/><input ref={mapInputRef} hidden type="file" accept=".gpx,application/gpx+xml" onChange={handleGpxImport}/>{showAdd&&<AddRunSheet onClose={()=>setShowAdd(false)} onSave={saveRun}/>} {celebration&&<Celebration run={celebration} onClose={()=>setCelebration(null)}/>} {toast&&<div className="toast"><MessageCircle size={16}/>{toast}</div>}
  </div>
}
